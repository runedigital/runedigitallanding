...
export default function Inferno({ primaryColor = '#ff3300', text = 'INFERNO', font }) {
  ...
  const finalColor = primaryColor || '#ff3300'
  ...
  return (
    ...
    >
      ...
      <Sparkles count={200} color={finalColor} size={8} speed={4} scale={10} noise={1} opacity={1} />
      <Stars radius={100} depth={50} count={3000} factor={4} saturation={0} fade />
      <OrbitControls enableZoom={false} autoRotate autoRotateSpeed={0.8} />
      <EffectComposer disableNormalPass>
        <Bloom luminanceThreshold={0.1} mipmapBlur intensity={2.0} radius={0.6} />
        <Noise opacity={0.2} /> 
        <ToneMapping />
      </EffectComposer>
    </Canvas>
